...
namespace TheDotNetLeague.MultiFormats.MultiCodecs
{
    /// <summary>
    ...
    ///         <list type="bullet">
    ///             <item>
    ///                 <description>ReadMultiCodec</description>
    ///             </item>
    ///             <item>
    ///                 <description>
    ///                     <see cref="WriteMultiCodec" />
    ///                 </description>
    ///             </item>
    ///         </list>
    ///     </para>
    ...
    /// <seealso cref="Catalyst.Core.Lib.Registry.Codec" />
    public static class MultiCodec
    {
        /// <summary>
        ///     Reads a <see cref="Catalyst.Core.Lib.Registry.Codec" /> from the <see cref="Stream" />.
        /// </summary>
        /// <param name="stream">
        ...
        /// <remarks>
        ///     If the <b>code</b> does not exist, a new <see cref="Catalyst.Core.Lib.Registry.Codec" /> is
        ///     registered with the <see cref="Catalyst.Core.Lib.Registry.Codec.Name" /> "codec-x"; where
        ...
        /// <summary>
        ///     Reads a <see cref="Catalyst.Core.Lib.Registry.Codec" /> from the <see cref="Google.Protobuf.CodedInputStream" />.
        /// </summary>
        /// <param name="stream">
        ...
        /// <summary>
        ///     Writes a <see cref="Catalyst.Core.Lib.Registry.Codec" /> to the <see cref="Stream" />.
        /// </summary>
        /// <param name="stream">
        ///     A multicodec encoded <see cref="Stream" />.
        /// </param>
        /// <param name="name">
        ///     The <see cref="Catalyst.Core.Lib.Registry.Codec.Name" />.
        /// </param>
        /// <remarks>
        ///     Writes the <see cref="Varint" /> of the <see cref="Catalyst.Core.Lib.Registry.Codec.Code" /> to
