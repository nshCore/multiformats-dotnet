...
namespace TheDotNetLeague.MultiFormats.MultiBase
{
    /// <summary>
    ...
    public static class MultiBase
    {
        ...
        ///     The name of the multi-base algorithm to use. See
        ///     <see href="https://github.com/multiformats/multibase/blob/master/multibase.csv" />.
        /// </param>
        /// <returns>
